...
3. Based on your answer to #2, make a plot that shows the number of colleges in the top 10 cities. #how to get top_n to work
```{r}
colleges %>% 
  count(CITY) %>% 
  top_n(10, n) %>% 
...
```{r}
colleges %>%
  ggplot(aes(x=ADM_RATE, y=COSTT4_A))+geom_point()
```
