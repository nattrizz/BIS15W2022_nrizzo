...
The x-axis numebrs are not organized where they can be plotted. 
...
```{r}
plants <-read_csv(here("lab8", "data", "plant_data.csv"))
plants
```

2. Why are these data not tidy?  
The days are a variable when we need to plot them --- column names are observations**
